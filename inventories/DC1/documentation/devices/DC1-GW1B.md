...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 192.168.111.62/24 | 192.168.111.1 |
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet7 | 1600 | routed | access | - | - | - | 10.1.0.41/31 | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet7 | 1600 | routed | access | - | - | - | 10.1.0.43/31 | - | - |
| Ethernet3 | P2P_LINK_TO_DC2-GW1B_Ethernet3 | 1600 | routed | access | - | - | - | 10.0.0.46/31 | - | - |
| Ethernet4 | P2P_LINK_TO_DC2-GW1B_Ethernet4 | 1600 | routed | access | - | - | - | 10.0.0.48/31 | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.1.1.8/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.1.2.8/32 |
...
| Neighbor | Remote AS |
| -------- | ---------
| 10.0.0.47 | Inherited from peer group DCI-DC2-IPv4-UNDERLAY-PEERS |
| 10.0.0.49 | Inherited from peer group DCI-DC2-IPv4-UNDERLAY-PEERS |
| 10.1.0.40 | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 10.1.0.42 | Inherited from peer group IPv4-UNDERLAY-PEERS |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Tenant_A_OP_Zone | 10.1.1.8:11 |  65100:11  |  |  | learned | 110 |
| Tenant_B_OP_Zone | 10.1.1.8:21 |  65100:21  |  |  | learned | 210 |
| Tenant_C_OP_Zone | 10.1.1.8:31 |  65100:31  |  |  | learned | 310 |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Tenant_A_OP_Zone | 10.1.1.8:11 | connected |
| Tenant_B_OP_Zone | 10.1.1.8:21 | connected |
| Tenant_C_OP_Zone | 10.1.1.8:31 | connected |
