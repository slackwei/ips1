...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 192.168.111.38/24 | 192.168.111.1 |
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet4 | 1600 | routed | access | - | - | - | 10.1.0.25/31 | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet4 | 1600 | routed | access | - | - | - | 10.1.0.27/31 | - | - |
| Ethernet3 | MLAG_PEER_DC1-LEAF2A_Ethernet3 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 3 | active |
| Ethernet4 | DC1-L2LEAF2_Ethernet2 | *1500 | *switched | *trunk | *111,211 | - | - | - | 4 | active |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.1.1.6/32 |
...
| --------- | ----------- | --- | ---------- | ------------------ | -------------------------------- |
| Vlan111 | Tenant_A_OP_Zone_2 | Tenant_A_OP_Zone | 10.1.11.22/24 | - | 10.1.11.1 |
| Vlan211 | Tenant_B_OP_fw | Tenant_B_OP_Zone | - | - | - |
| Vlan311 | Tenant_C_OP_fw | Tenant_C_OP_Zone | - | - | - |
| Vlan3010 | MLAG_PEER_L3_iBGP: vrf Tenant_A_OP_Zone | Tenant_A_OP_Zone | 10.255.251.5/31 | - | - |
| Vlan3020 | MLAG_PEER_L3_iBGP: vrf Tenant_B_OP_Zone | Tenant_B_OP_Zone | 10.255.251.5/31 | - | - |
| Vlan3030 | MLAG_PEER_L3_iBGP: vrf Tenant_C_OP_Zone | Tenant_C_OP_Zone | 10.255.251.5/31 | - | - |
| Vlan4093 | MLAG_PEER_L3_PEERING | default | 10.255.251.5/31 | - | - |
...
| Neighbor | Remote AS |
| -------- | ---------
| 10.1.0.24 | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 10.1.0.26 | Inherited from peer group IPv4-UNDERLAY-PEERS |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Tenant_A_OP_Zone | 10.1.1.6:11 |  65100:11  |  |  | learned | 111 |
| Tenant_B_OP_Zone | 10.1.1.6:21 |  65100:21  |  |  | learned | 211 |
| Tenant_C_OP_Zone | 10.1.1.6:31 |  65100:31  |  |  | learned | 311 |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Tenant_A_OP_Zone | 10.1.1.6:11 | connected |
| Tenant_B_OP_Zone | 10.1.1.6:21 | connected |
| Tenant_C_OP_Zone | 10.1.1.6:31 | connected |
